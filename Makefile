...
CLIBS1 += -I/opt/eigen-3.3.7/include/eigen3 -I/mnt/data1/dsr/cub -L${CUDALIBDIR} -lcudart
...
CFLAGS1 += -arch=sm_75 --default-stream per-thread -O3 --expt-relaxed-constexpr -I/mnt/data1/dsr/mkfit-hackathon/eigen -I/mnt/data1/dsr/cub
...
CFLAGS1+= -arch=sm_75 -O3 -DUSE_GPU --default-stream per-thread -DALPAKA_ACC_GPU_CUDA_ENABLED --expt-relaxed-constexpr --expt-extended-lambda
